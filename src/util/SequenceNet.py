...
if(len(sys.argv) ==3):
    ...
    model.add(layers.Conv2D(32, (3 , 3), activation='relu', input_shape=(h,w, 1 if bw==0 else 3), padding='valid'))
...
# history=model.fit(train_set, train_label, validation_data=(val_set, val_label),epochs=int(epocs), batch_size=batch_size) #aggiusta batch size
